...
export const metadata = { 
  ...
  description: "Professional aligner soaking boxes and high-frequency cleaners." 
};
    ...
    <main className="pt-24 pb-20 min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto">Maintain hygiene with our clinical-grade soaking technology.</p>
        </div>
