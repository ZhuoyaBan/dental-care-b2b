      ...
      <main className="pt-24 bg-gray-50 min-h-screen">
        <section className="bg-gray-900 text-white py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-3xl md:text-5xl font-bold mb-4">Dental Accessories</h1>
            <p className="text-gray-400 max-w-2xl">Essential tools including removers, chewies, and brushes.</p>
          </div>
        </section>
