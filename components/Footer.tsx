...
const companyLinks = [
  ...
  { label: "Branded Box Gallery", href: "/dental-gift-box-design-gallery" },
...
// Group products by category for cleaner footer display
const categories = [
  {
    name: "Retainer Cases",
    slug: "retainer-case",
    items: products.filter(p => p.category === "retainer-case"),
  },
  {
    name: "Cleaning Boxes",
    slug: "cleaning-box",
    items: products.filter(p => p.category === "cleaning-box"),
  },
  {
    name: "Gift Boxes",
    slug: "gift-box",
    items: products.filter(p => p.category === "gift-box"),
  },
  {
...
export default function Footer() {
  ...
  return (
    <>
      ...
      <Link
        href="/#contact"
        aria-label="Request a wholesale quote"
      ...
      >
        ...
        <div className="w-14 h-14 bg-blue-600 hover:bg-blue-700 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center justify-center">
          <svg className="w-7 h-7 text-white" viewBox="0 0 24 24" fill="currentColor">
            <path d="M4 4h16v12H7l-3 3V4zm4 4h8M8 12h5" />
          </svg>
        </div>
      </Link>
