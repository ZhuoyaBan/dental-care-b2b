  ...
  const icons: Record<string, React.ReactNode> = {
    ...
    chewies: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M4 7v10c0 1.933 3.582 3.5 8 3.5s8-1.567 8-3.5V7" />
      </svg>
    ),
    bag: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    brush: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9.06 11.9l8.07-8.07a2.85 2.85 0 114.03 4.04l-8.06 8.06" />
        <path d="M7.07 14.94C5.79 16.22 4 16.5 4 16.5s.28-1.79 1.56-3.07l1.51-1.52 2 2.02-1.52 1.51z" />
      </svg>
    ),
  };
...
function ProductCard({ product }: { product: Product }) {
  return (
    <div className="group relative bg-white rounded-2xl border border-gray-100 p-6 flex flex-col hover:shadow-xl hover:border-blue-100 hover:-translate-y-1 transition-all duration-300">
      {/* Category badge */}
      ...
      {/* Icon container */}
      <div
        className={`w-14 h-14 ${product.iconBg} rounded-2xl flex items-center justify-center mb-5 transition-transform duration-300 group-hover:scale-110`}
      >
        <ProductIcon
      ...
      {/* Text */}
      <h3 className="text-base font-bold text-gray-800 mb-1 group-hover:text-blue-600 transition-colors duration-200">
        {product.name}
      </h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto">
            From UV sterilizers to cleaning brushes — everything your clients need
            for a complete aligner care routine, all available under your brand.
          </p>
        </div>
