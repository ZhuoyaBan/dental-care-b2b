...
const landingPageEntries = [
  ...
  {
    title: "Private-Label Accessories for North America",
    desc: "A sourcing route for U.S. and Canadian dental brands, labs and distributors building branded aligner care ranges.",
    href: "/private-label-aligner-accessories-north-america",
    icon: "🌎",
  },
  {
    title: "Aligner Care Kits for Australia",
    desc: "Plan a branded patient handover kit for Australian orthodontic clinics and clear-aligner brands.",
